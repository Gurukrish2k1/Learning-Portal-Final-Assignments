...
('Krish', CAST(N'2023-01-11 2:30:09.000' AS DateTime), CAST(N'2023-02-10 9:12:07.000' AS DateTime), 1);
...
select * from UserDetails where FirstName like 'k%' order by CreatedDate desc;
select FirstName, Email from UserDetails where ModifiedDate>'2023-02-10';
select * from UserGroup1 where Descriptions is null order by Names;
