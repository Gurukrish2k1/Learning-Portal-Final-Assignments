...
select Designation,sum(Salary) as Salary from UserDetails group by Designation;

select City, Designation, sum(Salary) as Salary, count(ID) as [Total no of Users] from UserDetails group by City, Designation;
