...
INSERT INTO UserDetails VALUES(4, 'Akshay',  'T', 'Krish@gmail.com', 'Trichy', 10000, 'Developer', CAST(N'2023-02-11 2:30:09.000' AS date), CAST(N'2023-03-10 9:12:07.000' AS date), '1');
INSERT INTO UserDetails VALUES( 5,'AAdhi',  'T', 'Krish@gmail.com', 'Chennai', 700000, 'Engineer', CAST(N'2023-02-11 2:30:09.000' AS date), CAST(N'2023-03-10 9:12:07.000' AS date), '1');
...
select * from UserDetails where FirstName like 'A%' order by createddate asc;
 
select FirstName, Email, ModifiedDate from UserDetails where ModifiedDate>'2023-01-10' order by FirstName;
 
select * from UserGroup where description is null order by Names;
